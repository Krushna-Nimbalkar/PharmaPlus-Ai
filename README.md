...
- MR can create a PR (drug proposal), which stores a drug and triggers email notifications to matching doctors.
...
## Branch & PR Workflow
- If your GitHub UI shows **View PR** instead of **Create PR**, that branch already has an open PR.
- Create a new branch and push at least one new commit to open a fresh PR diff.
